...
copilotTTC <- 140 #insert the co-pilot's estimated time to complete (in minutes, it is fine to approximate) e.g., 120
...
*Co-pilot note: It might be helpful to point out that the original "Order" column contains participants' ID #s, since that column name isn't very intuitive. I'm also not sure if it's necessary to include the Age, Gender, or Year_born columns in the tidied dataframe, since those variables were not ultimately used in the analysis.*

*Co-pilot note: Data is still not in traditional tidy format. The lack of tidy data did not prove to be a major issue, however, since the pilot successfully carried out all analyses using wide data. If someone was seeking to tidy the data for future analyses, a 'gather' function would be very useful.*
...
*Co-pilot note: I think we can remove this pre-processing step, since it was already done above.* 
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '3.99', obtainedValue = T1_curiosity[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '3.74', obtainedValue = T1_curiosity[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '4.24', obtainedValue = T1_curiosity[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '2.84', obtainedValue = T1_Surprise[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '2.64', obtainedValue = T1_Surprise[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '3.05', obtainedValue = T1_Surprise[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '3.81', obtainedValue = T1_meaningfulness[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '3.60', obtainedValue = T1_meaningfulness[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '4.03', obtainedValue = T1_meaningfulness[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '3.95', obtainedValue = T1_interest[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '3.73', obtainedValue = T1_interest[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '4.18', obtainedValue = T1_interest[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '3.54', obtainedValue = T1_interest_comp[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '3.34', obtainedValue = T1_interest_comp[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '3.73', obtainedValue = T1_interest_comp[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '4.34', obtainedValue = T2_curiosity[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '4.10', obtainedValue = T2_curiosity[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '4.58', obtainedValue = T2_curiosity[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '3.25', obtainedValue = T2_Surprise[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '3.06', obtainedValue = T2_Surprise[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '3.44', obtainedValue = T2_Surprise[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '4.04', obtainedValue = T2_meaningfulness[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '3.84', obtainedValue = T2_meaningfulness[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '4.23', obtainedValue = T2_meaningfulness[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '4.19', obtainedValue = T2_interest[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '4.00', obtainedValue = T2_interest[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '4.38', obtainedValue = T2_interest[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '3.82', obtainedValue = T2_interest_comp[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '3.65', obtainedValue = T2_interest_comp[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '4.00', obtainedValue = T2_interest_comp[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '0.35', obtainedValue = curiosity_diff[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '0.11', obtainedValue = curiosity_diff[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '0.59', obtainedValue = curiosity_diff[3], valueType = 'ci')
```
...
```{r T2 - T1 Surprise}
ci_Surprised_diff <- ci(data_complete$Surprised_diff, confidence = 0.95)
surprise_diff <- c(round(c(mean(data_complete$Surprised_diff), ci_Surprised_diff[2], ci_Surprised_diff[3]), digits = 2))
surprise_diff

# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '0.40', obtainedValue = surprise_diff[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '0.19', obtainedValue = surprise_diff[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '0.62', obtainedValue = surprise_diff[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '0.22', obtainedValue = meaning_diff[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '0.03', obtainedValue = meaning_diff[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '0.42', obtainedValue = meaning_diff[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '0.23', obtainedValue = interest_diff[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '0.02', obtainedValue = interest_diff[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '0.45', obtainedValue = interest_diff[3], valueType = 'ci')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '0.29', obtainedValue = interest_comp_diff[1], valueType = 'mean')
reportObject <- reproCheck(reportedValue = '0.10', obtainedValue = interest_comp_diff[2], valueType = 'ci')
reportObject <- reproCheck(reportedValue = '0.47', obtainedValue = interest_comp_diff[3], valueType = 'ci')
```
...
*Co-pilot note: Quoting section of Target Outcomes that this portion of the Markdown file seeks to reproduce:*
...
reportObject <- reproCheck(reportedValue = '2.88', obtainedValue = t_curiosity[1], valueType = 't')
reportObject <- reproCheck(reportedValue = '0.35', obtainedValue = t_curiosity[5], valueType = 'mean')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '0.27', obtainedValue = d_curious, valueType = 'd')
```
...
*Co-pilot note: These analyses were not in the Target Outcomes, but it's great that the pilot calculated them regardless! Unfortunately, the original authors did not provide t-statistics for these outcomes, so we cannot run a ReproCheck.*
...
reportObject <- reproCheck(reportedValue = '3.10', obtainedValue = t_interest_comp[1], valueType = 't')
reportObject <- reproCheck(reportedValue = '0.29', obtainedValue = t_interest_comp[5], valueType = 'mean')
```
...
# Co-pilot note: Adding ReproCheck for the values above!
reportObject <- reproCheck(reportedValue = '0.29', obtainedValue = d_interest, valueType = 'd')
```
...
*Co-pilot note: I (and the ReproCheck) agree with the minor discrepancy that Leili notes above!*

# Step 5: Conclusion

All results were consistent with the reported findings in the paper except for a minor rounding error in effect size. Here's a table similar to Table 1 in the original paper:
